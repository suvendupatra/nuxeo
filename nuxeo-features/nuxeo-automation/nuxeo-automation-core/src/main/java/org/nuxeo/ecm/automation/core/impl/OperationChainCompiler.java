...
class OperationChainCompiler {
    ...
    CompiledChain compile(OperationChainTypeImpl typeof, Class<?> typein) throws OperationException {
    ...
    class Key {
        final OperationChainTypeImpl typeof;
        final Class<?> typein;
        final int hashcode;

        Key(OperationChainTypeImpl typeof, Class<?> typein) {
            this.typeof = typeof;
            this.typein = typein;
