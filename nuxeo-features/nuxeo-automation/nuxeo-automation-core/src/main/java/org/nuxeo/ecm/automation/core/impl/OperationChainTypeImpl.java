 ...
 */
public class OperationChainTypeImpl implements OperationType {
    ...
    public OperationChainTypeImpl(AutomationService service, OperationChain chain, OperationChainContribution contribution) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof OperationChainTypeImpl)) {
            return false;
        }
        OperationChainTypeImpl other = (OperationChainTypeImpl) obj;
        if (chain == null) {
            if (other.chain != null) {
                return false;
            }
    ...
    public static OperationChainTypeImpl typeof(OperationChain chain, boolean replace) {
        return new OperationChainTypeImpl(Framework.getService(AutomationService.class), chain, OperationChainContribution.contribOf(chain, replace));
    }
