...
public class AutomationScriptingComponent extends DefaultComponent {
    ...
    protected AutomationScriptingImpl service;

    @Override
    public void registerContribution(Object contribution, String extensionPoint, ComponentInstance contributor) {
        if (contribution instanceof AutomationScriptingOperationDescriptor) {
            registry.addContribution((AutomationScriptingOperationDescriptor) contribution);
        } else {
    ...
    public void unregisterContribution(Object contribution, String extensionPoint, ComponentInstance contributor) {
        if (contribution instanceof AutomationScriptingOperationDescriptor) {
            registry.removeContribution((AutomationScriptingOperationDescriptor) contribution);
        } else {
            log.error("Unknown extension point " + extensionPoint);
        }
    }
    ...
    public void applicationStarted(ComponentContext context) {
        ...
        service = new AutomationScriptingImpl();
        ...
        Framework.addListener(new RuntimeServiceListener() {
            ...
            public void handleEvent(RuntimeServiceEvent event) {
                ...
                registry.stream().forEach(contrib -> {
                    try {
                        AutomationScriptingOperationTypeImpl type = new AutomationScriptingOperationTypeImpl(service,
                                automation, contrib);
    ...
    public <T> T getAdapter(Class<T> adapter) {
        if (adapter.isAssignableFrom(AutomationScripting.class)) {
