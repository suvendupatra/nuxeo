...
import org.nuxeo.automation.scripting.api.AutomationScripting.Context;
 ...
 * @since 7.2
 */
public class AutomationScriptingOperation {
    ...
    public AutomationScriptingOperation(String script, OperationContext ctx, Map<String, Object> args) {
        this.script = script;
        this.ctx = ctx;
        this.args = args;
    }
    ...
    public Object run() throws Exception {
        try (Context session = Framework.getService(AutomationScripting.class).get(ctx)) {
