 ...
 */
package org.nuxeo.automation.scripting.internals.wrappers;
...
public class AutomationMapper implements Bindings {
    ...
    public Object executeOperation(String opId, Object input, ScriptObjectMirror parameters) throws Exception {
        ...
        Object output = automation.compileChain(input == null ? Void.TYPE : input.getClass(), new OperationParameters(opId, DocumentScriptingWrapper.unwrap(parameters))).invoke(ctx);
        return wrap(output);
    }
