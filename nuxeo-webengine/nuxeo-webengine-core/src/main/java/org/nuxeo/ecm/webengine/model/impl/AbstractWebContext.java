...
public abstract class AbstractWebContext implements WebContext {
    ...
    UriRuleContext ruleContext;

    public void setRuleContext(UriRuleContext ruleContext) {
        this.ruleContext = ruleContext;
    }

    @Override
    public Resource newObject(ResourceType type, Object... args) {
        Resource obj = type.newInstance(ruleContext);
        try {
    ...
    public AdapterResource newAdapter(Resource ctx, String serviceName, Object... args) {
        ...
        AdapterResource service = (AdapterResource) st.newInstance(ruleContext);
        try {
