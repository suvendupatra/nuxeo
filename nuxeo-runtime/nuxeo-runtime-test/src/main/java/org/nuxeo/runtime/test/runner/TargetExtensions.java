...
public abstract class TargetExtensions {
    protected Set<Pair<String, String>> targetExtensions = new HashSet<>();

    protected TargetExtensions() {
        initialize();
    }

    public Set<Pair<String, String>> getTargetExtensions() {
        return targetExtensions;
    }

    public void addTargetExtension(String name, String extension) {
        targetExtensions.add(Pair.of(name, extension));
    }
